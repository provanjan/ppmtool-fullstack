...
public class BacklogController {
	...
	public ResponseEntity<?> updateProjectTask(@RequestBody ProjectTask updatedProjectTask, @PathVariable String backlog_id,@PathVariable String pt_id, BindingResult result){
		ResponseEntity<?> errorMap=mapValidationErrorService.mapValidationError(result);
		if(errorMap!=null) return errorMap;
		ProjectTask updatedProjTask=projectTaskService.updateByProjectTaskSequence(updatedProjectTask, backlog_id, pt_id);
